...
KAS Studio is a batteries-included product built on
...
![People and Agents collaborating through KAS](docs/assets/studio-collaboration.png)
...
```bash
./studio/scripts/preview.sh
```

The script builds Core and the Studio packages, creates an isolated temporary
...
[Studio technical reference](docs/technical-reference.md).
...
Studio does not hide collaboration data in a separate chat database. The
...
![KAS Studio product architecture](docs/assets/studio-architecture.png)
...
KAS Core supplies the stable Resource control plane. Studio features are
...
- [Studio documentation](docs/README.md)
- [Studio technical reference](docs/technical-reference.md)
