...
KAS Studio 是构建在 [KAS Core](../README.zh-CN.md) 之上的开箱即用产品。它把
...
![用户与 Agent 通过 KAS 协作](docs/assets/studio-collaboration.png)
...
- [Studio 文档索引](docs/README.zh-CN.md)
- [Studio 技术参考](docs/technical-reference.md)
